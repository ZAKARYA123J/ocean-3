        ...
        <div className="relative pt-6 px-4 sm:px-6 lg:px-8">
          ...
          >
            ...
            <div className="hidden md:block md:ml-10 md:pr-4 md:space-x-8">
              ...
              <a
                href="#"
                className={`font-medium text-sky hover:text-sky no-underline`}
              >
                Call to action
              </a>
            </div>
          ...
          >
            ...
            >
              ...
              <a
                ...
                className={`block w-full px-5 py-3 text-center font-medium text-sky bg-gray-50 hover:bg-gray-100 no-underline`}
              >
                {callToAction.text}
              </a>
            </div>
